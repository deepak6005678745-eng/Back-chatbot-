...
GOOGLE_CLIENT_ID = os.getenv("GOOGLE_CLIENT_ID") # Cloud console wali ID .env me rakhna
...
if not MONGO_URI:
    ...
    try:
        ...
        users_collection = db['users'] # Users save karne ke liye naya collection
...
def google_auth():
    ...
    try:
        ...
        user_google_id = idinfo.get("sub") # Unique Google User ID
